...
### Added
- **Windows EXE build** - standalone executable for Windows users
  - Single file application (~30 MB)
  - No Python installation required
  - Includes all dependencies (Pillow, tkinter)
  - Custom icon (app_icon.ico)
  - Available in `releases/` folder
- `CLAUDE.md` - project documentation for AI assistants
- PyInstaller spec file (`RenameMedia.spec`) for reproducible builds

### Changed
- Updated `.gitignore` to allow EXE files in `releases/` folder
...
[1.4.1]: https://github.com/maimik/rename-media/compare/v1.4.0...v1.4.1
